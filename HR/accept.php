...
if(isset($_SESSION['hruser']))
	{
  $selectQuery ="SELECT Dept, emailAddress FROM hr WHERE emailAddress = '".$_SESSION['hruser']."'";
...
$count = 0;
      while($row = mysqli_fetch_assoc($result))
        ...
        $d=$row['Dept'];
    		...
    		$select = "SELECT e.Work_ID,e.Dept,e.EmpName,el.EmpName,el.LeaveType,el.RequestDate,el.LeaveDays,el.StartDate,el.EndDate,el.id,el.Dept FROM employees e, emp_leaves el WHERE e.Dept = el.Dept AND el.Statusv = 'Waiting...' AND e.EmpName = el.EmpName";
