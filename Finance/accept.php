...
{
  $d=$row['department'];
  $select = "SELECT e.*,el.EmpName,el.LeaveType,el.RequestDate,el.LeaveDays,el.StartDate,el.EndDate,el.id,el.Dept FROM employees e, emp_leaves el WHERE e.Dept = el.Dept AND el.Statusv = 'Requested' AND e.EmpName = el.EmpName AND  e.Dept = '".$_SESSION['dept']."'";
